...
/* harmony default export */ var arrows = (function (Splide, Components, name) {
  ...
  function createArrow(prev) {
    var arrow = "<button class=\"" + classes.arrow + " " + (prev ? classes.prev : classes.next) + "\" type=\"button\">" + ("<svg xmlns=\"" + XML_NAME_SPACE + "\"\tviewBox=\"0 0 " + SIZE + " " + SIZE + "\"\twidth=\"40\"\theight=\"40\">") + ("<path d=\"" + (Splide.options.arrowPath || PATH) + "\" />");
    return domify(arrow);
  }
...
$("#first_tab").on('click', function(){
	...
	$('.tab-content li').addClass('hidden');
	$('#first').removeClass('hidden');
});
$("#two_tab").on('click', function(){
	$(this).siblings('li').removeClass('active');
	$(this).addClass('active');
	$('.tab-content li').addClass('hidden');
	$('#two').removeClass('hidden');
});
$("#three_tab").on('click', function(){
	$(this).siblings('li').removeClass('active');
	$(this).addClass('active');
	$('.tab-content li').addClass('hidden');
	$('#three').removeClass('hidden');
});
$("#four_tab").on('click', function(){
	$(this).siblings('li').removeClass('active');
	$(this).addClass('active');
	$('.tab-content li').addClass('hidden');
	$('#four').removeClass('hidden');
})
$('.tab-content li img').on('click', function(){
